...
Read data from the test system which corresponds to an integration on the energy parameter($\epsilon$) to find the coexistence pressure(p) between a crystalline and an isotropic phase.
